...
const clients: Client[] = [
  ...
  { name: "Bumi Menara Internusa", logo: "/Bumi Menara Internusa-logo.jpg", featured: true, description: "Implemented Robotic Process Automation (RPA) to automate export documentation, streamlining workflows across multiple divisions and external authority portals to cover comprehensive pre-shipment and post-shipment processes." },
  { name: "BSI Syariah", logo: "/BSI Syariah.png", featured: true, description: "Designed and implemented an IoT-enabled Smart Vault system for Bullion Banking, integrating custom hardware and software components to secure and optimize business processes. " },
