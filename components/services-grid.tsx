...
export function ServicesGrid() {
  const services = [
    ...
    // Service #4: Talent Re and Upskilling (BARU DITAMBAHKAN)
    {
      icon: Users,
      title: "Talent Re and Upskilling – catching up the digital challenges",
      description: "We help companies to build a new Learning & Development strategy by moving away from traditional classroom training and adopting Talent Re and Upskilling strategy :",
      points: [
    ...
    // Service #5: Strategic Domains (BARU DITAMBAHKAN)
    {
      icon: Globe,
      title: "Strategic & specific domains, digitalization consultation services",
      description: "TS provides near turn-key service comprises both consulting & solution development to help Indonesian corporations benefiting the progress of digital technology and culture :",
      points: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            TS resources, the partners and the engineering team, comprehend the set of expertise needed for TS to perform its mission and deliver its services with high standard . These are the most needed services when it comes to corporate/ organization digitalization:
          </p>
        </div>
              ...
              <div className="md:col-span-2">
                ...
                {service.hasBrochure && (
                  <div className="mt-8 flex justify-center"> 
                    <Button className="bg-green-500 hover:bg-green-600 text-white font-bold px-8 py-6 text-base">
                      Download Brochure
                    </Button>
                  </div>
                )}
